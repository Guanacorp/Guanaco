 ...
 */
class GenerateDomainModel extends Command
{
    protected static $defaultName = 'guanaco:generate:domain:model';
    ...
    {
        $this
            ->setDescription('Generates Model for a Domain Driven Guanaco package')
            ->addArgument('package', InputArgument::REQUIRED, 'The package where the Model belongs to')
