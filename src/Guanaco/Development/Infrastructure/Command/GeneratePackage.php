...
{
    protected static $defaultName = 'guanaco:generate:package';
    ...
    {
        $this
            ->setDescription('Generates a new Domain Driven Guanaco package')
            ->addArgument('package', InputArgument::REQUIRED, 'The name of the package to generate')
        ;
    }
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->messageBus->dispatch(new GenerateApiCommand($package));
